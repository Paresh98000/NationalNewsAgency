...
if (isset($_POST['add_draft'])) {
	...
	if($lang=="Hindi"){
		$query = "insert into tbl_news_h (tittle,description,details,authorid,editorid,categoryID,language,img_id, end_date)";
		$query .= "value ('$title','$news_discrpt','$news_content','$empid','$empid','$newscat','$lang',$last_image_id,'2019-12-05')";
		//echo $query;
